...
export default function Sidebar() {
    ...
    return (
        <div className="flex z-[100] justify-center fixed transition-all duration-300 bg-gray-100 top-0 right-0 flex-col h-screen w-64  text-black">
            <div className="flex flex-col items-center justify-center h-16 bg-gray-100">
            ...
            <nav className="flex-grow w-full mt-4">
                <ul className="flex flex-col justify-center items-start gap-y-3 w-full">
                    ...
                    <li className="w-full p-1" id="bu-users-accordion">
                        <Link className={`p-2 gap-x-2 flex items-center transition-all duration-200 hover:bg-white  text-sm text-slate-700 rounded-md ${pathname === "/blogs" ? "bg-white" : ""}`}  href="/">
                            <img
