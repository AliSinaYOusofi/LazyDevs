...
export default function Example() {
    ...
    return (
        <>
            <div id="nav" className="mx-auto z-[99]      px-4 lg:px-8 py-2 bg-gray-100 w-full">
                <div className="container relative mx-auto flex items-center justify-evenly">    
                    ...
                    <div className="flex items-center relative">
                        ...
                        <svg onClick={() => setSearchInputs(prev => !prev)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 md:hidden cursor-pointer">
