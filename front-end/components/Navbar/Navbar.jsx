...
export default function Example() {
    ...
    return (
        <Navbar className="mx-auto z-[999] fixed left-[50%] translate-x-[-50%] w-[90%] max-w-screen-xl py-2 px-4 lg:px-8 lg:py-4 mt-1 rounded-[0.3rem]">
        <div className="container relative mx-auto flex items-center justify-between text-blue-gray-900 my-auto">
            ...
            <svg ref={containerRef} onClick={() => setOptions(prev => !prev)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 hidden lg:inline-flex cursor-pointer text-black">
