...
export default function FetchPostError({error}) {
    ...
    return (
        <div id="fetchErrorMessage" className=" py-3 flex items-center ml-4 gap-x-4 justify-center px-4 leading-normal text-red-700 bg-red-100 rounded-lg" role="alert">
            <p>{error}</p>
