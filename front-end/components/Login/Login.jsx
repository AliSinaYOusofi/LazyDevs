            ...
            <div className="">
                ...
                <div className="mt-5">
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                        ...
                        <button type="button" onClick={handleSubmit} className="block w-full shadow-md shadow-current transition-all duration-300 hover:bg-black hover:text-white mt-4 py-2 rounded-md  font-semibold mb-2">Create Account</button>
