...
export default function BlogCard({content, title, username, profileUrl, date, id}) {
    ...
    return (
        <div style={{backdropFilter:"blur(10px)", backgroundColor: "rgba(8, 112, 184, 0.7);"}} className="max-w-2xl px-8 py-4 mx-auto  rounded-lg shadow-[0_10px_1000px_rgba(8,_112,_184,_0.7)] mt-4" id={id}>
