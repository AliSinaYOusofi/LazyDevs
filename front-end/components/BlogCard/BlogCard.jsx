...
export default function BlogCard({content, title, username, profileUrl, date, id, width, clamp, viewCount, dateDistance, saved, tags, author, likes, commentsCount}) {
    ...
    return (
        <>
            ...
            <div className={`${width ? "w-full" : "max-w-2xl"} px-8 py-4 mx-auto bg-white transition-all duration-100  from-pink-500 via-red-500 to-yellow-500  rounded-lg mt-4`} id={id}>
                ...
                <div className="flex items-center justify-between ">
                    ...
                    <div className="flex items-center gap-x-2 justify-center bg-gray-50 p-1 rounded-md">
