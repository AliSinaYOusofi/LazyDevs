...
export default function SingleUserPostBlogTemplate({title, date, viewCount, commentCount, dateDifference, id, parentUseEffectTrigger, likes, body, tags, commentsCount}) {
