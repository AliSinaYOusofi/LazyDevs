...
export default function NotLoggedInCard({closeCard, onClose}) {
    ...
    return (
        <div className="w-fit pointer-events-auto bg-gray-100 border-none outline-none rounded-md p-10 mt-10" id="hidelogin">
            
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-semibold mb-2"> Log in to continue</h1>
            ...
            <p className="text-gray-400">We're a place where people share, stay up-to-date and grow their careers.</p>
