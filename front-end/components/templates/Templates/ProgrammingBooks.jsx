...
export default function ProgrammingBooks() {
    ...
    return (
        <div className="max-w-2xl mx-auto px-4 py-8 blog">
            ...
            <p> The tried-and-tested techniques and strategies explained in the book assist programmers and software developers to: </p>
            <ul>
                <li>Benefit from collaborative development</li>
                <li>Develop software with minimum complexity</li>
                <li>Fasten the debugging process</li>
                <li>Maximize creativity</li>
                <li>Reduce errors and issues</li>
                <li>Refactor and evolve code</li>
            </ul>

            <h1> 6. Design Patterns: Elements of Reusable Object-Oriented Software </h1>
            <p>Don’t you know what software design patterns are? The Design Patterns: Elements of Reusable Object-Oriented Software is one of the authority tomes on the topic. And yes, it is not an easy read.</p>
            <img src={"https://cdn.hackr.io/uploads/posts/attachments/BA0bDMZSatE6jsBLZZKS4o2wBFbwwK5vzdrE917R.webp"} alt="image" />

            <p>If you don’t have a good grasp over UML, you might find it difficult to ingest some of the information and examples compiled in the programming book. That, however, will not stop you from appreciating the beauty of the narration in the Design Patterns book, which is easy and informative.</p>
            <p>The Design Patterns book exhaustively explains 23 software design patterns that help software developers and designers in crafting better, elegant, and flexible software. The book discusses a galore of concise and straightforward solutions to usual software design problems.</p>
            <p> Even though you know what software design patterns are, you must add the Design Patterns: Elements of Reusable Object-Oriented Software book to your library to further refine your understanding of the topic and have a quick reference when the need arises. </p>

            <h1> 7. The Pragmatic Programmer </h1>
            <p> Since its creation in 1999 by its authors to aid its clientele to develop better software, The Pragmatic Programmer has succeeded in becoming one of the highly-revered programming books. This book is for every coder looking to transcend to be a skilled software developer and a full-fledged programmer. </p>
