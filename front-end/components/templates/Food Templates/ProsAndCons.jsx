...
export default function ProsAndCons({pros, cons}) {
    ...
    return (
        <div className="w-fit bg-yello bg-yellow-200 rounded-md flex flex-col mx-auto p-10 my-4">
            <h1 class="flex items-center"> <span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-16 h-16">
