...
export default function SocialIcons({post_id}) {
    ...
    return (
        <div className="flex md:ml-4 ml-0 md:flex-col flex-row md:items-center md:justify-center socials md:mt-0 mt-4 gap-4 mr-4 md:mr-0">
            ...
            <div className=" p-2 rounded-full flex flex-col items-center justify-center cursor-pointer">
            ...
            <div onClick={() => moveToId("comments")} className=" p-2 rounded-full flex flex-col gap-x-2 items-center justify-center cursor-pointer">
