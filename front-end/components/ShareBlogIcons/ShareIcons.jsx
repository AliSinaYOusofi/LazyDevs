...
export default function SocialIcons({post_id}) {
    ...
    return (
        <div className="flex md:ml-4 ml-0 md:flex-col flex-row items-center justify-center socials md:mt-0 mt-4 gap-4 mr-4 md:mr-0">
            ...
            <div onClick={handleLikes} className=" md:p-2 rounded-full flex flex-col items-center justify-center  md:mt-10 cursor-pointer">
                
                <button disabled={spinner} className="mt-3 md:mt-4">
                    {
                        liked || alreadyLikes
                        ?
